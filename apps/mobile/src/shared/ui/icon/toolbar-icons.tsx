 ...
 * sized reliably. The PNGs are the same Material Symbols glyphs `Icon` draws
 * as paths elsewhere, exported at 1x, 2x and 3x.
 *
...
const toolbarIcons = {
  back: {
    ...
    ios: "chevron.backward" as SFSymbol,
  },
  newChat: {
    android:
      require("../../../../assets/toolbar/new-chat.png") as ImageSourcePropType,
    ios: "square.and.pencil" as SFSymbol,
  },
  profile: {
    android:
