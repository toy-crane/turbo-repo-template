 ...
 *
 * Each platform draws its own: SwiftUI's `ProgressView` on iOS, Compose's
 * `LoadingIndicator` on Android. There is no universal component for either, so
 * the file is split rather than branched — an iOS bundle never loads the Compose
 * view, and an Android bundle never loads the SwiftUI one.
 *
